...
- Users pay Base L2 gas fees only once to register their handles (under $0.01 per handle).
- Users host their own node (hardware + electricity costs) or defer to a managed operator.

If you're an app developer, dive into the [Archeum SDK](https://github.com/archeum-dev/archeum-sdk) to get started!